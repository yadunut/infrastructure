...
#+begin_src yaml :tangle ansible/roles/nomad_server/tasks/main.yaml :mkdirp yes :comments link

#+end_src

#+begin_src hcl :tangle ansible/roles/nomad_server/templates/nomad.hcl.j2 :mkdirp yes :comments link
datacenter = "dc1"
data_dir = "/opt/nomad"
